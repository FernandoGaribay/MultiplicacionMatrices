...
public class Concurrente extends javax.swing.JFrame implements ProgresoListener {
...
//        JOptionPane.showMessageDialog(this, "Matriz A Eliminada", "Informacion", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Concurrente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Concurrente().setVisible(true);
            }
        });
    }
